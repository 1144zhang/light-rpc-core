package com.zhang.registry.zk.util;

import com.zhang.enums.RpcConfigEnum;
import com.zhang.utils.PropertiesFileUtil;
...
public final class CuratorUtils {
    ...
    public static void createPersistentNode(CuratorFramework zkClient, String path) {
        try {
            if (REGISTERED_PATH_SET.contains(path) || zkClient.checkExists().forPath(path) != null) {
                ...
                //eg: /my-rpc/com.zhang.HelloService/127.0.0.1:9999
     ...
     *
     * @param rpcServiceName rpc service name eg:com.zhang.HelloServicetest2version1
     ...
     *
     * @param rpcServiceName rpc service name eg:com.zhang.HelloServicetest2version
     */
